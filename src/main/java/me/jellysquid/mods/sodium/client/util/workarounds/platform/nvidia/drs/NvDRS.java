package me.jellysquid.mods.sodium.client.util.workarounds.platform.nvidia.drs;
...
public class NvDRS {
    private static class Functions {
        ...
        private static final long NvAPI_DRS_SetSetting = NvAPI.getFunction(0xCC176068);
