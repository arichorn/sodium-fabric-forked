package me.jellysquid.mods.sodium.client.util.workarounds.platform.nvidia.core;

import me.jellysquid.mods.sodium.client.util.workarounds.platform.nvidia.core.util.NvShortString;
import me.jellysquid.mods.sodium.client.util.workarounds.platform.nvidia.drs.*;
...
public class NvAPI {
    ...
    static {
        SHARED_LIBRARY = Library.loadNative(NvAPI.class, "me.jellysquid.mods.sodium", "C:/Windows/System32/nvapi64.dll", false);
    }
