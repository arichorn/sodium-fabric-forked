package me.jellysquid.mods.sodium.client.util.workarounds.platform.nvidia.drs.structures;
...
import me.jellysquid.mods.sodium.client.util.workarounds.platform.nvidia.drs.enums.NVDRSSettingValues;
...
// NVDRS_SETTING_V1
public class NVRDSSettingV1 extends Struct {
    ...
    public static NVRDSSettingV1 allocateStack(MemoryStack stack) {
        return wrap(NVRDSSettingV1.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
